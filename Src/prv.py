...
class IndustrialInspectionUI:
    ...
    # ==============================================================================
    # QUẢN LÝ CAMERA & TẢI ẢNH
    # ==============================================================================
    def toggle_live_camera(self):
        """Bật/tắt camera live stream trên frame bên trái"""
    ...
    def update_live_ui(self):
        """Render frame camera lên giao diện theo realtime"""
        if self.is_live_running:
    ...
    def live_camera_loop(self):
        """(Template) Luồng đọc dữ liệu từ phần cứng camera"""
        return

    def capture_image(self):
        """(Template) Ghi lại frame hiện tại từ live stream"""
        return
